...
Life cycle: experimental. Read "Neurodata Without Borders" ('NWB'
format) file. Unlike other readers `read_nwb` returns low-level 'Python'
class handler via `pynwb` module.
...
A [`NWBHDF5IO`](http://dipterix.org/ieegio/reference/NWBHDF5IO.md)
instance
